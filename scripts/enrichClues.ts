...
// Meticulously authored supplemental clues (7 items per story, added to existing 5 to total 12 per story)
// Each clue is factually grounded, objective, with timeline, discussion prompt, and bilingual support.

const STORY_EXTRA_CLUES: Record<string, any[]> = {
  dreams: [
    {
      id: "ev_dreams_6",
...
console.log('Script loaded helper definitions');
