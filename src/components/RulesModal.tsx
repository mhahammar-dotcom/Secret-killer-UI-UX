  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-4" dir="rtl">
      <motion.div
        ...
        className="relative w-full max-w-lg max-h-[85vh] rounded-[28px] bg-[#0d0f16] border-2 border-[#c8923a]/50 p-5 sm:p-6 shadow-[0_8px_32px_rgba(0,0,0,0.9)] overflow-y-auto flex flex-col gap-4 text-right custom-scrollbar"
      >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-amber-900/30 pb-3">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-xl font-black font-['Cairo'] text-[#f5ebd9]">طريقة وقواعد اللعبة</h3>
          </div>
          <button
            onClick={() => {
              sound.playClick();
        ...
        <div className="grid grid-cols-2 gap-2 text-xs font-['Cairo']">
          <div className="flex items-center gap-2 p-2.5 rounded-2xl bg-black/40 border border-[#7a5c2b]/40 text-[#f5ebd9]">
            ...
            <span>مناقشة حرة وبحث عن تناقضات</span>
          </div>
          <div className="flex items-center gap-2 p-2.5 rounded-2xl bg-black/40 border border-[#7a5c2b]/40 text-[#f5ebd9]">
            <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
            <span>معلوماتك السرية لك وحدك</span>
          </div>
          <div className="flex items-center gap-2 p-2.5 rounded-2xl bg-black/40 border border-[#7a5c2b]/40 text-[#f5ebd9]">
            <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
            <span>أدلة تحقيق متاحة للجميع</span>
          </div>
          <div className="flex items-center gap-2 p-2.5 rounded-2xl bg-black/40 border border-[#7a5c2b]/40 text-[#f5ebd9]">
            <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
            <span>تصويت سري وحسم بالأغلبية</span>
          </div>
        </div>

        {/* Step-by-step How to Play */}
        <div className="space-y-3 text-xs sm:text-sm text-[#d4cfc7] leading-relaxed font-['Cairo']">
          ...
          <div className="p-3.5 rounded-2xl bg-black/40 border border-[#7a5c2b]/40">
            <strong className="text-[#f3cb79] block font-black text-sm mb-1">
              2. المناقشة الحرة واستعراض الأدلة 🕵️‍♂️
            </strong>
            <p>
